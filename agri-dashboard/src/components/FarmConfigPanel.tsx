import { Settings, MapPin, Navigation, ChevronDown, Sprout, Droplets } from 'lucide-react';
...
const CROP_SUGGESTIONS = ['Wheat', 'Corn', 'Barley', 'Tomato', 'Potato', 'Sunflower', 'Cotton', 'Soybean'];
          ...
          <FieldGroup label="Growth Stage" hint="Affects water demand calculation">
            <div className="relative">
              <select
                ...
                className="modern-input appearance-none pr-8"
